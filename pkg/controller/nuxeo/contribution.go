...
func (r *ReconcileNuxeo) configureContributions(instance *v1alpha1.Nuxeo, dep *appsv1.Deployment, nodeSet v1alpha1.NodeSet) error {
	var err error
...
func (r *ReconcileNuxeo) configureCmContrib(dep *appsv1.Deployment, namespace string, nuxeoContainer *corev1.Container,
...
// because each will have to be explicitly configured in the Volume specifier. Then calls 'configureDeployment' to
// actually configure the passed Deployment.
func (r *ReconcileNuxeo) configureSecretContrib(dep *appsv1.Deployment, namespace string, nuxeoContainer *corev1.Container,
