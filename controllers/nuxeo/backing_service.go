...
// needed.
func (r *NuxeoReconciler) configureBackingService(instance *v1alpha1.Nuxeo, backingService v1alpha1.BackingService,
...
func (r *NuxeoReconciler) projectMount(namespace string, backingServiceName string,
...
// gen is performed.
func (r *NuxeoReconciler) projectTransform(namespace string, backingServiceName string,
	resource v1alpha1.BackingServiceResource, projection v1alpha1.ResourceProjection, dep *appsv1.Deployment,
	secondarySecret *corev1.Secret) error {
	var resVer string
	var err error
	...
	if projection.Transform.Type == v1alpha1.KeyStore {
		if privateKey, _, err = r.getValueFromResource(resource, namespace, projection.Transform.PrivateKey); err != nil {
			return err
		}
	}
...
func (r *NuxeoReconciler) loadSecondary(resource v1alpha1.BackingServiceResource, namespace string,
	secondarySecret *corev1.Secret, resVer string, keys ...string) error {
	obj := corev1.Secret{}
	if err := r.Get(context.TODO(), types.NamespacedName{Name: secondarySecret.Name, Namespace: namespace},
		&obj); err != nil {
...
func (r *NuxeoReconciler) reconcileSecondary(instance *v1alpha1.Nuxeo, secondarySecret *corev1.Secret) error {
...
func (r *NuxeoReconciler) getValueFromResource(resource v1alpha1.BackingServiceResource, namespace string,
	...
	if gvk == ".v1.secret" {
		...
		obj := corev1.Secret{}
		if err := r.Get(context.TODO(), types.NamespacedName{Name: resource.Name, Namespace: namespace}, &obj); err != nil {
...
func (r *NuxeoReconciler) defaultSecondarySecret(instance *v1alpha1.Nuxeo,
